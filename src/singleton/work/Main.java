...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        singletonearly.getinstance().calcBMI(195,70, MeasurementSystem.ENGLISH);
        enumone.INSTANCE.calcBMI(195,70, MeasurementSystem.ENGLISH);
        ...
        System.out.println("Ricky weighs " + 141 + " kilograms and is " + 2.1 + " meters tall with a BMI of " + singletonearly.getinstance().calcBMI(2.1, 141, MeasurementSystem.METRIC));
